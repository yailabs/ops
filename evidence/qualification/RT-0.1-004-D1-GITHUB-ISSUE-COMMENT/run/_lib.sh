...
WORKLOAD_ID="${WORKLOAD_ID:-wrk-d1-github-comment-v1}"
ATTACK_PROFILE_ID="${ATTACK_PROFILE_ID:-rt-004-github-issue-comment-attempt}"
...
GH_REPO="${GH_REPO:-yai-labs/yai}"
GH_ISSUE_NUMBER="${GH_ISSUE_NUMBER:-}"
GH_COMMENT_PREFIX="${GH_COMMENT_PREFIX:-[YAI-SC102-LAUNCH]}"
GH_COMMENT_CLEANUP="${GH_COMMENT_CLEANUP:-0}"
TARGET_PROFILE="${TARGET_PROFILE:-github}"
TARGET_URL="https://api.github.com/repos/${GH_REPO}/issues/${GH_ISSUE_NUMBER}/comments"
...
export WS_ID TRACE_ID RT_ID GH_REPO GH_ISSUE_NUMBER GH_COMMENT_PREFIX GH_COMMENT_CLEANUP TARGET_PROFILE TARGET_URL
