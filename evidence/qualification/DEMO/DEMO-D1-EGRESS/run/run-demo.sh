...
{
  echo "$ cd docs/40-qualification/RT-0.1-001-D1-EGRESS-CURL"
  echo "$ BASELINE_ID=baseline-deny TARGET_PROFILE=local ./run/run-three.sh"
...
echo "[DEMO-D1] Runtime prepared and captures saved under $ARTIFACTS_DIR"
