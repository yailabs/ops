...
## Included templates / pointers
- Pilot SOW template: /collateral/sow/
...
- Support model
- IP and licensing notes (to be finalized)

## Data and security notes (outline)
- Data handling boundaries
- Evidence retention and access
- Optional DPA/security addendum (as required)
